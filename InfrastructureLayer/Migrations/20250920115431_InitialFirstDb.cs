...
namespace InfrastructureLayer.Migrations
{
    ...
    public partial class InitialFirstDb : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    UserRatingId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    RateeUserAccountId = table.Column<int>(type: "int", nullable: false),
                    RaterUserAccountId = table.Column<int>(type: "int", nullable: false),
                    RequestId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserRating_UserAccount_RateeUserAccountId",
                        column: x => x.RateeUserAccountId,
                        principalSchema: "dbo",
                        principalTable: "UserAccount",
                        principalColumn: "UserAccountId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserRating_UserAccount_RaterUserAccountId",
                        column: x => x.RaterUserAccountId,
                        principalSchema: "dbo",
                        principalTable: "UserAccount",
                        principalColumn: "UserAccountId",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserRating_RateeUserAccountId",
                schema: "dbo",
                table: "UserRating",
                column: "RateeUserAccountId");

            migrationBuilder.CreateIndex(
                name: "IX_UserRating_RaterUserAccountId",
                schema: "dbo",
                table: "UserRating",
                column: "RaterUserAccountId");
