...
namespace InfrastructureLayer.Migrations
{
    ...
    [Migration("20250921175958_InitialFirsDb")]
    partial class InitialFirsDb
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DomainLayer.Entities.Conversation", b =>
                {
                    ...
                    b.Property<bool>("IsUser1Blocked")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bit")
                        .HasDefaultValue(false);

                    b.Property<bool>("IsUser2Blocked")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bit")
                        .HasDefaultValue(false);
            ...
            modelBuilder.Entity("DomainLayer.Entities.RequestStatusHistory", b =>
                {
                    ...
                    b.Property<int>("RequestSelectionId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DomainLayer.Entities.Wallet", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.HasIndex("UserAccountId", "Currency")
                        .IsUnique();

                    b.ToTable("Wallet", "dbo");
                });

            modelBuilder.Entity("DomainLayer.Entities.WalletTransaction", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("DomainLayer.Entities.Conversation", b =>
                {
                    ...
                    b.HasOne("DomainLayer.Entities.UserAccount", "User2")
            ...
            modelBuilder.Entity("DomainLayer.Entities.Message", b =>
                {
                    ...
                    b.HasOne("DomainLayer.Entities.UserAccount", "Sender")
            ...
            modelBuilder.Entity("DomainLayer.Entities.WalletTransaction", b =>
                {
                    b.HasOne("DomainLayer.Entities.Wallet", "Wallet")
